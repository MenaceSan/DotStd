...
namespace DotStd
{
    ...
    public class TaskInst
    {
        ...
        public object? GetInstance()
        {
            if (_oInstance == null)
            {
                ...
                ValidState.ThrowIfNull(_oType, nameof(_oType));
    ...
    public class TaskDesc
    {
        ...
        protected Type[]? _aMethodArgTypes = null;   // What types for the arguments to _sMethodCall ? So we can deal with signatures and overloads.
